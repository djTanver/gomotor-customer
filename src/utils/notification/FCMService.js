...
class FCMService {
    ...
    // register = (onRegister, onNotification, onOpenNotification, callback) => {
    //     this.checkPermission(onRegister)
    //     this.createNotificationListeners(onRegister, onNotification, onOpenNotification, callback)
    // }
    ...
    // createNotificationListeners = (onRegister, onNotification, onOpenNotification, callback) => {
    ...
    //             }
    //             Alert.alert('remoteMessage------->',remoteMessage.data);
    //             callback(remoteMessage.data);
